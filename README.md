...
1. *taxi_orders* - **Прогнозирование заказов такси**
...
2. *cost_of_cars* - **Определение стоимости автомобилей**
...
5. *location for wells* - **Выбор локации для скважины**
...
6. *customer_churn* - **Отток клиентов**
...
7. *tariff_recommendation* - **Рекомендация тарифов**
...
8. *success_of_video_games* - **Определение критериев успешности видео игр** 
